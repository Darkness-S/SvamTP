package main.java.automaton.finite;
...
public class FiniteState extends State {
	...
	public FiniteState addTransition(FiniteState state, String label, char... cs) {
		for (char c : cs) {
			FiniteTransition transition = new FiniteTransition(state, c,label);
